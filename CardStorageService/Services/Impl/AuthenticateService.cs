...
namespace CardStorageService.Services.Impl
{
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public const string SecretKey = "TopSecretTopSecret";
        ...
        public AuthenticationResponse Login(AuthenticationRequest request)
        {
            ...
            Account account = !string.IsNullOrWhiteSpace(request.Login) ? FindAccountByLogin(context, request.Login) : null;
            ...
            return new AuthenticationResponse { Status = AuthenticationStatus.Success, SessionInfo = sessionInfo};
        }
        ...
        {
            return context.Accounts.FirstOrDefault(x => x.EMail == login);
        }
    }
}
