    ...
    public partial class AccountsAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountSessionы", x => x.SessionId);
                    table.ForeignKey(
                        name: "FK_AccountSessionы_Accounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountSessionы_AccountId",
                table: "AccountSessionы",
                column: "AccountId");
        }
